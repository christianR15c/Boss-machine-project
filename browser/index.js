...
const appEnter = (nextRouterState) => {
  Promise.all([
    axios.get('http://boss-mchine.herokuapp.com/api/minions'),
    axios.get('http://boss-mchine.herokuapp.com/api/ideas'),
    axios.get('http://boss-mchine.herokuapp.com/api/meetings'),
  ])
...
const singleMinionEnter = (nextRouterState) => {
  ...
  axios
    .get(`http://boss-mchine.herokuapp.com/api/minions/${id}`)
    .then((res) => res.data)
    .then((minion) => {
  ...
  axios
    .get(`http://boss-mchine.herokuapp.com/api/minions/${id}/work`)
    .then((res) => res.data)
    .then((work) => {
...
const singleIdeaEnter = (nextRouterState) => {
  const id = nextRouterState.params.id;
  axios
    .get(`http://boss-mchine.herokuapp.com/api/ideas/${id}`)
    .then((res) => res.data)
    .then((idea) => {
