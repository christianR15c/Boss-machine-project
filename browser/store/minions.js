...
export const createMinionThunk = (minion) => (dispatch) => {
  axios
    .post('http://boss-mchine.herokuapp.com/api/minions', minion)
    .then((res) => res.data)
    .then((createdMinion) => {
...
export const updateMinionThunk = (minion) => (dispatch) => {
  axios
    .put(`http://boss-mchine.herokuapp.com/api/minions/${minion.id}`, minion)
    .then((res) => res.data)
    .then((updatedMinion) => {
...
export const deleteMinionThunk = (minionId) => (dispatch) => {
  axios
    .delete(`http://boss-mchine.herokuapp.com/api/minions/${minionId}`)
    .then((res) => res.data)
    .then(() => {
      return axios.get(`http://boss-mchine.herokuapp.com/api/minions`);
    })
    .then((res) => res.data)
    .then((allMinions) => {
